...
class ScoreBoard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Row(
      ...
      children: [
        Score(label: 'امتیاز', score: '$score'),
        const SizedBox(
          width: 8.0,
        ),
        Score(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        Text(
          label.toUpperCase(),
          style: const TextStyle(fontSize: 18.0, color: color2 , fontFamily: 'IranSansX'),
        ),
        Text(
          score,
          style: const TextStyle(
              color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18.0 , fontFamily: 'IranSansX'),
        )
      ]),
    );
  }
